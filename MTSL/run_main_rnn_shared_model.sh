#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python main_rnn_shared_model.py --rnn_mode LSTM --num_epochs 200 --batch_size 16 \
 ...
 --weight_path "data/embedding/elmo_weight.hdf5" --word2index_path "output/rnn_shared_model/chunk/word2index" \
 --out_path "output/rnn_shared_model/chunk" --use_crf "True" --use_lm "True" --use_elmo "True" \
 --lm_mode "shared" --label_type "chunk" "fgner" \
