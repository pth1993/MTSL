...
parser = argparse.ArgumentParser(description='Hierarchical-Shared Model')
...
parser.add_argument('--bucket_auxiliary', nargs='+', help='bucket auxiliary')
parser.add_argument('--bucket_main', nargs='+', help='bucket main')
